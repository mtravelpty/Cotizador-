...
export default function CotizadorPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#faf7f9]">
      <Sidebar
        view={view}
        onView={(v) => {
      ...
      <main className="flex-1 overflow-x-hidden bg-[#faf7f9]">
...
const TIPO_MAP: Record<CategoriaServicio, ServicioSeleccionado["tipo"]> = {
  hoteleria: "hotel",
  traslados: "traslado",
  aereos:    "vuelo",
  catamaran: "catamaran",
...
function AgregarServicioAccordion({ onSave }: { onSave: (s: ServicioSeleccionado) => void }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-[#e8d5e0] overflow-hidden">
      <p className="text-[11px] font-semibold uppercase tracking-widest text-slate-400 px-4 pt-4 pb-3">
        Agregar servicio
      </p>
